    ...
    public class UniformGridPanel : VirtualizingPanel, IScrollInfo
    {
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            if (availableSize.Height.Equals(double.PositiveInfinity))
            {
                ...
                return new Size(childSize.Width * Columns, childSize.Height * Math.Min(this.Rows, Math.Ceiling((double)(itemCount / (double)Columns))));
            }
        ...
        private Size MeasureExtent(Size availableSize, int itemsCount)
        {
            ...
            {
                double pageHeight = this.Rows * childSize.Height;

                double sizeWidth = _viewport.Width;
                double sizeHeight = pageHeight * Math.Ceiling((double)itemsCount / (this.Rows * this.Columns));
        ...
        private Size GetChildSize(Size availableSize)
        {
            ...
            double height = ItemHeight > 0 ? ItemHeight : availableSize.Height / this.Rows;
